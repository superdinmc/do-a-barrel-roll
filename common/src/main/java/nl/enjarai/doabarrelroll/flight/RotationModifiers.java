...
public class RotationModifiers {
    ...
    public static RotationInstant banking(RotationInstant rotationInstant) {
        ...
        var currentRoll = ElytraMath.getRoll(player.getYaw(0), DoABarrelRollClient.left) * ElytraMath.TORAD;
        var strength = 10 * Math.cos(player.getPitch(0) * ElytraMath.TORAD) * ModConfig.INSTANCE.getBankingStrength();
